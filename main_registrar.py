...
class Registro(Frame):
    ...
    def create_wietgs(self):
        ...
        Entry(self.frame2,textvariable=self.nombre , font=('Holy Friday',12)).grid(column=1,row=2)
        Entry(self.frame2,textvariable=self.modelo , font=('Holy Friday',12)).grid(column=1,row=3)
        Entry(self.frame2,textvariable=self.precio , font=('Holy Friday',12)).grid(column=1,row=4)
        Entry(self.frame2,textvariable=self.cantidad , font=('Holy Friday',12)).grid(column=1,row=5)
        ...
        Button(self.frame4,command = self.mostrar_todo, text='MOSTRAR DATOS DE MYSQL', font=('Holy Friday',10), bg='#caffbf').grid(columnspan=3,column=0,row=3, pady=8)
        ...
        self.tabla.heading('Modelo', text='Apellido', anchor ='center')
        self.tabla.heading('Precio', text='Grado', anchor ='center')
        self.tabla.heading('Cantidad', text='Edad', anchor ='center')
